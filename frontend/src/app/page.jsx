    ...
    <>
      ...
      <section id="hero" className="relative min-h-screen flex items-center py-24 overflow-hidden bg-gradient-to-b from-orange-50 via-amber-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
                ...
                <div className="grid grid-cols-3 sm:grid-cols-5 gap-4 sm:gap-6 items-center">
                  ...
                  <div className="grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all duration-300">
                    <svg className="h-6" viewBox="0 0 124 24" fill="currentColor">
                      ...
                      <path d="M47.5 16h-5V8h5c2.209 0 4 1.791 4 4s-1.791 4-4 4zm0-10h-7v12h7c3.314 0 6-2.686 6-6s-2.686-6-6-6zM66.5 6h-9v12h2v-5h7c1.105 0 2-.895 2-2V8c0-1.105-.895-2-2-2zm0 5h-7V8h7v3zM80.5 6h-7v12h7c1.105 0 2-.895 2-2v-8c0-1.105-.895-2-2-2zm0 10h-5V8h5v8zM97.5 6h-9v12h2v-5h7c1.105 0 2-.895 2-2V8c0-1.105-.895-2-2-2zm0 5h-7V8h7v3zM107.5 6h-2v12h9v-2h-7v-10zM123.5 6h-9v12h9v-2h-7v-3h7v-2h-7V8h7z" className="text-gray-700" />
                    </svg>
                  </div>
                  <div className="grayscale opacity-70 hover:grayscale-0 hover:opacity-100 transition-all duration-300">
                    <svg className="h-6" viewBox="0 0 124 24" fill="currentColor">
          ...
          {/* Scroll indicator */}
          <div className={`absolute bottom-8 left-1/2 -translate-x-1/2 w-8 h-12 border-2 border-orange-500 rounded-full flex justify-center pt-2 transition-all duration-700 delay-1200 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
            <span className="sr-only">Scroll down</span>
            <div className="w-1.5 h-1.5 bg-orange-500 rounded-full animate-[scrollDown_2s_infinite]"></div>
          </div>
        </div>
      </section>
      { /*How it works */}
      ...
      {/* Newsletter Section */}
      <section id="newsletter" className="relative min-h-screen flex items-center py-24 overflow-hidden bg-gradient-to-br from-orange-50 to-amber-50">
        <div className="absolute -top-32 -right-32 w-96 h-96 bg-orange-100/30 rounded-full blur-3xl -z-10"></div>
        <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-amber-100/30 rounded-full blur-3xl -z-10"></div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            <div className="flex flex-col items-center text-center mb-8">
              <span className="px-3 py-1 rounded-full bg-orange-100 text-orange-600 font-medium text-sm mb-4 inline-block">Business Network</span>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 max-w-3xl">
                Join our community of forward-thinking business leaders
              </h2>
              <p className="text-xl text-gray-600 max-w-2xl">
                Subscribe to receive partnership opportunities, networking event invitations, and insights on strategic business collaborations.
              </p>
            </div>
            ...
            <form className="space-y-6 max-w-4xl mx-auto">
              ...
              <div className="flex items-start">
                <div className="flex items-center h-5">
                  <input
                    id="partnership-interests"
                    type="checkbox"
                    className="h-4 w-4 text-orange-600 border-gray-300 rounded focus:ring-orange-500"
                  />
                </div>
                <div className="ml-3 text-sm">
                  <label htmlFor="partnership-interests" className="font-medium text-gray-700">
                    I'm interested in receiving information about potential business partnerships
                  </label>
                </div>
              </div>
              ...
              <p className="text-xs text-gray-500 text-center mt-4">
                By subscribing, you agree to our Privacy Policy and consent to receive updates about our services, events, and partnership opportunities.
              </p>
            </form>
          </div>
        </div>
