...
const ViewBusiness = () => {
 ...
 // In both files, update handleChatClick:
 const handleChatClick = () => {
  if (businessData) {
    router.push(`/chat?type=business&receiverId=${businessData._id}&receiverName=${encodeURIComponent(businessData.businessName || businessData.fullName)}`);
  }
};
